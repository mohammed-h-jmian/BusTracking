        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StopPoints_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveExpired = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LineStopPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LineStopPoints_Lines_LineId",
                        column: x => x.LineId,
                        principalTable: "Lines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LineStopPoints_StopPoints_StopPointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineStopPoints_LineId",
                table: "LineStopPoints",
                column: "LineId");

            migrationBuilder.CreateIndex(
                name: "IX_LineStopPoints_StopPointId",
                table: "LineStopPoints",
                column: "StopPointId");
